...
import com.home.ticketmaster.TicketMaster.exceptions.ScreenAlreadyOccupiedException;
...
public class ShowService {
    ...
    private boolean checkIfShowCreationAllowed(@NonNull final Screen screen, final Date startTime,
